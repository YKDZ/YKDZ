...
<div align="left">
  <img src="https://skills.syvixor.com/api/icons?i=html,css,javascript,typescript,webassembly,java,kotlin,rust,vuejs,vike,vite,tauri,tailwindcss,unocss,shadcnui,nodejs,nestjs,mysql,postgresql,sqlite,trpc,zod,valibot,git,github,docker,linux,ubuntu,android,cloudflare,vercel,alibabacloud,apachemaven,gradle,nx,turborepo,oxc,prettier,visualstudiocode,intellijidea,deepseek,chatgpt,claudeai,githubcopilot,codex,ollama,dependabot" alt="Tech Stack" />
</div>
